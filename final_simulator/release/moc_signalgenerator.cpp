...
struct qt_meta_stringdata_SignalGenerator_t {
    QByteArrayData data[6];
    char stringdata[68];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SignalGenerator_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SignalGenerator_t qt_meta_stringdata_SignalGenerator = {
    {
...
QT_MOC_LITERAL(5, 55, 12)
    ...
    "SignalGenerator\0vehicleDataGenerated\0"
    "\0VehicleData\0data\0generateData"
};
...
void SignalGenerator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->vehicleDataGenerated((*reinterpret_cast< const VehicleData(*)>(_a[1]))); break;
        ...
        {
            typedef void (SignalGenerator::*_t)(const VehicleData & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SignalGenerator::vehicleDataGenerated)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject SignalGenerator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SignalGenerator.data,
      qt_meta_data_SignalGenerator,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SignalGenerator.stringdata))
...
// SIGNAL 0
void SignalGenerator::vehicleDataGenerated(const VehicleData & _t1)
{
