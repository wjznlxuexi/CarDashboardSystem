...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SpeedometerWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 40, 15)
    ...
    "SpeedometerWidget\0setTargetSpeed\0\0"
    "speed\0updateAnimation"
};
...
void SpeedometerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SpeedometerWidget *_t = static_cast<SpeedometerWidget *>(_o);
        switch (_id) {
        case 0: _t->setTargetSpeed((*reinterpret_cast< double(*)>(_a[1]))); break;
...
const QMetaObject SpeedometerWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SpeedometerWidget.data,
      qt_meta_data_SpeedometerWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SpeedometerWidget.stringdata))
        return static_cast<void*>(const_cast< SpeedometerWidget*>(this));
